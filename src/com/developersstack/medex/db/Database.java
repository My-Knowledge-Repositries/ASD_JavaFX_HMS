        ...
        try{
            patientTable.add(
                    new PatientDto("95","Hasika","Sandaruwan",
                            new SimpleDateFormat("yyyy-MM-dd").parse("1880-10-16"),GenderType.MALE,"Galle","hasika@gmail.com"));
            patientTable.add(
                    new PatientDto("124","Samantha","Bandara",
                            new SimpleDateFormat("yyyy-MM-dd").parse("1880-10-16"),GenderType.MALE,"Aluthgama","samantha@gmail.com"));
            patientTable.add(
                    new PatientDto("452","Namal","Chandana",
                            new SimpleDateFormat("yyyy-MM-dd").parse("1880-10-16"),GenderType.MALE,"Kalutara","namal@gmail.com"));
            patientTable.add(
                    new PatientDto("457","Wasantha","nihal",
                            new SimpleDateFormat("yyyy-MM-dd").parse("1880-10-16"),GenderType.MALE,"Wadduwa","wasantha@gmail.com"));
            patientTable.add(
                    new PatientDto("8745","Banda","samanmal",
                            new SimpleDateFormat("yyyy-MM-dd").parse("1880-10-16"),GenderType.MALE,"Panadura","banda@gmail.com"));
        }catch (Exception e){
            e.printStackTrace();
        }
